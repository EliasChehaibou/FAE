...
import { searchAnnonce, searchCategories, searchAnnonceCate, searchAnnonceRech, searchAnnonceRechCate } from '../../rest/search';
...
const Recherche = () => {
    ...
    function handleSearch() {
        ...
        if (document.getElementById('rech').value && valeur){
            navigate('/recherche?rech='+document.getElementById('rech').value+'&cat='+valeur);
